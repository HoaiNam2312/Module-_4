...
public class BlogService implements IBlogService {
    ...
    @Override
    public List<Blog> findByNameContaining(String searchName) {
        return iBlogRepository.findByNameContaining(searchName);
    }

//    @Override
//    public Page<Blog> search(String searchName) {
//        return iBlogRepository.findByNameContaining(searchName);
//    }
//
//    @Override
